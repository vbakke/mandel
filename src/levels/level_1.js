module.exports = {
    ...
    <p>                        
        ...
        and one part an <i>imaginary number</i>*, for example: $<%=yStr%>$  $i$. **
    </p>                        
    <p>                    
        The complex number is written as $<%=xStr%> <%=yStr%>i$, and we can draw this number in a coordinate system, just like  $x$, and $y$ <br/>
        $(x,y) = (<%=xStr%>, <%=yStr%>)$                        
    </p>
    <p>                    
